...
def serialHandler():
    ...
    while not stopped.is_set():
        ...
        if can_id == 0x0C0:
            ...
            database["LVPDB_main"] = buffer[4]
        elif can_id == 0x301:
            database["LVPDB_ch1"] = buffer[4]
        elif can_id == 0x302:
            database["LVPDB_ch2"] = buffer[4]
        elif can_id == 0x303:
            database["LVPDB_ch3"] = buffer[4]
            
        elif can_id == 0x304:
            database["LVPDB_brakelight"] = buffer[4] & 0x0F
            
        elif can_id == 0x305:
            database["LVPDB_pump"] = buffer[4] & 0x0F
